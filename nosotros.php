...
<div class="top-bar">
    ...
    <section class="hero-section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="display-4 mb-4">Servicio Medicos<br>hoy por ti mañana por mi</h1>
                    <p class="lead mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br>
                        Donec malesuada lorem maximus mauris scelerisque, at<br>
    ...
    <div class="content-wrapper">
        ...
        <div class="historia">
            ...
            <p>
                Fundada en 2010, nuestra clínica ha estado comprometida con brindar atención médica de calidad a la comunidad. 
                Con un equipo de profesionales altamente capacitados, nos esforzamos por ofrecer un ambiente acogedor y seguro para todos nuestros pacientes. 
                A lo largo de los años, hemos ampliado nuestros servicios y mejorado nuestras instalaciones para satisfacer las necesidades de nuestros pacientes.
            </p>
        </div>
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td class="day-column">
                                <span class="day-icon"><i class="fas fa-briefcase"></i></span>
                                Lunes - Viernes
                            </td>
                            <td class="hour-column">
                                <i class="fas fa-clinic-medical me-2"></i>8:00 - 20:00
                            </td>
                        </tr>
                        <tr>
                            <td class="day-column">
                                <span class="day-icon"><i class="fas fa-calendar-day"></i></span>
                                Sábado
                            </td>
                            <td class="hour-column">
                                <i class="fas fa-clinic-medical me-2"></i>8:00 - 17:00
                            </td>
                        </tr>
                        <tr>
                            <td class="day-column">
                                <span class="day-icon"><i class="fas fa-coffee"></i></span>
                                Domingo
                            </td>
                            <td>
                                <span class="emergency-badge">
                                    <i class="fas fa-ambulance emergency-icon"></i> Solo Emergencias
                                </span>
                            </td>
                        </tr>
                    </tbody>
